...
#define S_FUNCTION_NAME lbrBodyJacobians_sfun
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    ssSetOutputPortMatrixDimensions(S, 0, 7, 6); /* 1_J_1 */
    ssSetOutputPortMatrixDimensions(S, 1, 7, 6); /* 2_J_2 */
    ssSetOutputPortMatrixDimensions(S, 2, 7, 6); /* 3_J_3 */
    ssSetOutputPortMatrixDimensions(S, 3, 7, 6); /* 4_J_4 */
    ssSetOutputPortMatrixDimensions(S, 4, 7, 6); /* 5_J_5 */
    ssSetOutputPortMatrixDimensions(S, 5, 7, 6); /* 6_J_6 */
    ssSetOutputPortMatrixDimensions(S, 6, 7, 6); /* 7_J_7 */
...
static void mdlOutputs(SimStruct *S, int tid)
{
  ...
  double allJac[7][42];
  lbrBodyJacobiansDouble(q, allJac);
